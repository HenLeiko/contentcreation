     ...
     <section class="interesting">
         ...
         <div class="video-grid">
             <?php foreach ($data as $row): ?>
                 <a href="view/video/?id=<?=$row['id']?>">
                 <div class="video-item">
                     <img src="/resources/imgs/<?=$row['preview']?>" alt="Видео" class="video-item__preview">
                     <div class="video-item__wrapper">
                         <img src="../../img/avatar.png" alt="Аватар" class="video-item__avatar">
                         <div class="video-item__info">
                             <h4 class="video-item__title"><?=$row['title']?></h4>
                             <div class="video-item__user-name"><?=$row->users['login']?></div>
                         </div>
                     </div>
         ...
         <div class="get-more">Показать больше <img src="../../img/arrow-down.png" alt="V" class="get-more__arrow">
         </div>
     </section>
